...
import {List, ListItem, Content, Container, Button, Icon} from 'native-base'
...
const WIDTH = Dimensions.get('screen').width
 class Watch2 extends Component {
    constructor(props) {
        super(props)
    }
    renderSwiper=()=> {
            ...
            <View style={{height:hp(45),position: 'absolute', top: 0, left: 0, right: 0,backgroundColor:'white', marginTop:hp(1)}}>
                 <Swiper style={{flex:1}}
                    ...
                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch2.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>

                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch21.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>

                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch22.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>
                </Swiper>
            </View>
        )
                        ...
                        <Content>
                            <List >
                                  <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText  text='Big Bang Black Carbon Fiber' fontSize={wp(4)} />
                                    </ListItem>

                                    <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        <AppText text={strings.modelNumber} fontSize={wp(4)} color={color.MAIN_COLOR}/>
                                        <AppText  text='301.PB.131.RX' fontSize={wp(4)} />
                                    </ListItem>
                                    ...
                                    <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText  text='Black' fontSize={wp(4)} />
                                    </ListItem>
                                    ...
                                    <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText  text='Rubber' fontSize={wp(4)} />
                                    </ListItem>
    ...
    render() {
        return(
            <View style={{flex:1, backgroundColor:'white'}}>
                <StatusBar hidden/>
                <Header headerText={strings.watch2} backAction/>
                {this.renderSwiper()}
                {this.renderContent()}
            </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Watch2)