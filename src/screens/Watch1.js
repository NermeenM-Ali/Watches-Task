...
import {View, StatusBar, Dimensions, Image, ScrollView, TouchableOpacity} from 'react-native'
import Swiper from 'react-native-swiper'
import { heightPercentageToDP as hp, widthPercentageToDP as wp } from 'react-native-responsive-screen'
import {List, ListItem, Container, Content, Icon, Button} from 'native-base'
...
class Watch1 extends Component {
    constructor(props) {
        super(props)
    }
    renderSwiper=()=> {
            ...
            <View style={{height:hp(45),position: 'absolute', top: 0, left: 0, right: 0,backgroundColor:'white', marginTop:hp(1)}}>
                 <Swiper style={{flex:1}}
                    ...
                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch1.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>

                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch12.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>

                    <View style={{justifyContent:'center', alignItems:'center'}}>
                         <Image source={require('../assets/imgs/watch13.jpg')} style={{width:wp(60), height:hp(30), marginTop:hp(12)}}/>
                    </View>
                </Swiper>
            </View>
        )
                            ...
                            <List >
                                  <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                    ...
                                    <ListItem  style={{justifyContent:'space-between',flexDirection:this.props.isRtl? 'row-reverse': 'row'}}>
                                        ...
                                        <AppText  text='Blue' fontSize={wp(4)} />
                                    </ListItem>
    ...
    render() {
        return(
            <View style={{flex:1, backgroundColor:'white'}}>
                <StatusBar hidden/>
                <Header headerText={strings.watch1} backAction />
                {this.renderSwiper()}
                {this.renderContent()}
            </View>
        )
...
export default connect(mapStateToProps, mapDispatchToProps)(Watch1)